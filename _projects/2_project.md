...
- (2022) Explainable Deep Learning Model for EMG-Based Finger Angle Estimation Using Attention **in** *IEEE Trans. Neural Syst. Rehabil. Eng.* doi:[10.1109/TNSRE.2022.3188275](https://ieeexplore.ieee.org/document/9829861/)

- (2023) Investigation of Real-Time Control of Finger Movements Utilising Surface EMG Signals **in** *IEEE Sens. J.* doi:[10.1109/JSEN.2023.3299384](https://ieeexplore.ieee.org/document/10201474/)

- (2023) Enhanced Lightweight CNN Using Joint Classification with Averaging Probability for sEMG-Based Subject-Independent Hand Gesture Recognition **in** *IEEE Sens. J.* doi:[10.1109/JSEN.2023.3296649](https://ieeexplore.ieee.org/document/10190329/)

- (2023) A Transformer-Based Multi-Task Learning Framework for Myoelectric Pattern Recognition Supporting Muscle Force Estimation **in** *IEEE Trans. Neural Syst. Rehabil. Eng.* doi:[10.1109/TNSRE.2023.3298797](https://ieeexplore.ieee.org/document/10194336/)

- (2023) Proportional and Simultaneous Real-Time Control of the Full Human Hand From High-Density Electromyography **in** *IEEE Trans. Neural Syst. Rehabil. Eng.* doi:[10.1109/TNSRE.2023.3295060](https://ieeexplore.ieee.org/document/10182328/)

- (2023) Iterative Self-Training Based Domain Adaptation for Cross-User Semg Gesture Recognition **in** *IEEE Trans. Neural Syst. Rehabil. Eng.* doi:[10.1109/TNSRE.2023.3293334](https://ieeexplore.ieee.org/document/10175382/)

- (2023) Multi-View Fusion Network-Based Gesture Recognition Using Semg Data **in** *IEEE J. Biomed. Health Inform.* doi:[10.1109/JBHI.2023.3287979](https://ieeexplore.ieee.org/document/10158011/)

- (2023) Interventionalist Hand Motion Recognition with Convolutional Neural Network in Robot-Assisted Coronary Interventions **in** *IEEE Sens. J.* doi:[10.1109/JSEN.2023.3281009](https://ieeexplore.ieee.org/document/10144568/)

- (2023) Gesture Recognition Based On Eemd and Cosine Laplacian Eigenmap **in** *IEEE Sens. J.* doi:[10.1109/JSEN.2023.3279555](https://ieeexplore.ieee.org/document/10138677/)

- (2023) High-Accuracy Hand Gesture Recognition On the Wrist Tendon Group Using Pneumatic Mechanomyography (Pmmg) **in** *IEEE Trans. Ind. Inform.* doi:[10.1109/TII.2023.3280312](https://ieeexplore.ieee.org/document/10136753/)

- (2023) Emaha-Db1: A New Upper Limb Semg Dataset for Classification of Activities of Daily Living **in** *IEEE Trans. Instrum. Meas.* doi:[10.1109/TIM.2023.3279873](https://ieeexplore.ieee.org/document/10135136/)
...
- (2023) STMI: Stiffness Estimation Method Based on sEMG-Driven Model for Elbow Joint **in** *IEEE Trans. Instrum. Meas.* doi:[10.1109/TIM.2023.3300424](https://ieeexplore.ieee.org/document/10198348/)

- (2023) A Transformer-Based Multi-Task Learning Framework for Myoelectric Pattern Recognition Supporting Muscle Force Estimation **in** *IEEE Trans. Neural Syst. Rehabil. Eng.* doi:[10.1109/TNSRE.2023.3298797](https://ieeexplore.ieee.org/document/10194336/)

- (2023) Online Decomposition of Surface Electromyogram Into Individual Motor Unit Activities Using Progressive Fastica Peel-Off **in** *IEEE. Trans. Biomed. Eng.* doi:[10.1109/TBME.2023.3294016](https://ieeexplore.ieee.org/document/10179173/)

- (2023) A Layered Semg–Fmg Hybrid Sensor for Hand Motion Recognition From Forearm Muscle Activities **in** *IEEE T. Hum.-Mach. Syst.* doi:[10.1109/THMS.2023.3287594](https://ieeexplore.ieee.org/document/10177680/)

- (2023) Development of a High-Snr Stochastic Semg Processor in a Multiple Muscle Elbow Joint **in** *IEEE Trans. Neural Syst. Rehabil. Eng.* doi:[10.1109/TNSRE.2023.3281410](https://ieeexplore.ieee.org/document/10146313/)
...
- (2023) A 3DCNN-LSTM Hybrid Framework for sEMG-Based Noises Recognition in Exercise **in** *IEEE Access*. doi:10.1109/ACCESS.2020.3021344.

## Rehabilitation

- (2023) Interactive Virtual Ankle Movement Controlled by Wrist Semg Improves Motor Imagery: An Exploratory Study **in** *IEEE Trans. Vis. Comput. Graph.* doi:[10.1109/TVCG.2023.3294342](https://ieeexplore.ieee.org/document/10178041/)
